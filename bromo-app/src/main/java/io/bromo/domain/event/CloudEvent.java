...
/**
 * CloudEvents 1.0 envelope. Carries the required context attributes plus the
 * opaque {@code data} payload. Use {@link #data()} as-is for serialisation; do
 * not wrap or transform the user payload.
 */
