...
/**
 * Event type registry. Bromo is schema-agnostic - any type passes through. This
 * registry only contains the example types shipped in the boilerplate; replace
 * with your own domain types.
 *
