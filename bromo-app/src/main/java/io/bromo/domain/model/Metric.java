 ...
 */
public record Metric(String type, String metricName, Instant bucketStart, double value) {

  /**
   * Compose the Cassandra partition key for {@code metrics_by_hour}. Format: {@code
   * "<type>|<metricName>|<yyyy-MM>"}.
   */
