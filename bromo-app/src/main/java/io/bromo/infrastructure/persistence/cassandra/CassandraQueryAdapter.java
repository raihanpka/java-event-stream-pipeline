...
/**
 * Read-side query adapter. Wires the application service interfaces to the Cassandra repositories.
 * Spring component scan picks it up once {@code CassandraTemplate} is on the classpath.
 */
@Service
